    ...
    <div className="w-full">
      {!uploadedFile ? (
        <div
          {...getRootProps()}
          className={`
            glass-card border-2 border-dashed p-10 text-center cursor-pointer
        ...
        >
          ...
          <div className="flex flex-col items-center gap-5">
            ...
            {hasErrors && (
              <div className="mt-2 px-4 py-2 bg-red-500/20 border border-red-400/30 rounded-lg">
        ...
        <div className="glass-card p-5 hover:shadow-glow transition-all duration-300">
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={handleClear}
              className="flex-shrink-0 p-2 text-red-300 hover:bg-red-500/20 rounded-xl transition-all duration-200 hover:scale-110"
